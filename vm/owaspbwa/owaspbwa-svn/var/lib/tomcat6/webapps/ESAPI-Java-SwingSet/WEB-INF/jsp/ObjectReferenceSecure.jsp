...
String profile = (String)request.getAttribute("profile");
	...
	String href="?function=ObjectReference&mode=secure&user=";
%>
...
<br />  
First, click on the profile links and note the URL. Then try changing the URL to view other users' profiles. 
Because the GET parameter is randomized and converted to the true username by an ESAPI AccessReferenceMap, attackers cannot guess new usernames.<br />
