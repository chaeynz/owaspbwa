...
<b><a href="main?function=Randomizer&lab">Lab: Randomizer</a></b> |
...
<h4>JSP Location: WebContent\WEB-INF\jsp\RandomizerLab.jsp</h4>
...
<form name="secureDemo" action="?function=Randomizer&lab" method="POST">
	<div>
		<h4>Generate a random boolean</h4>
		Random Boolean: <font color="green"><span id="randomBoolean"></span></font>
		<br /><br />
		<input type="button" value="Get Random Boolean" onclick="sendAjaxRequest('ajax?function=Randomizer&lab&method=getRandomBoolean&timestamp='+timestamp(),'booleanChanged')" />
	</div>
	<div>
		...
		<input type="button" value="Submit" onclick="sendAjaxRequest('ajax?function=Randomizer&lab&method=getRandomFileName&fileExtension=' + document.secureDemo.fileExtension.value + '&timestamp=' + timestamp(),'randomFileNameChanged')">
	...
	<div>
		...
		<input type="button" value="Submit" onclick="sendAjaxRequest('ajax?function=Randomizer&lab&method=getRandomInteger&min=' + document.secureDemo.min.value + '&max=' + document.secureDemo.max.value + '&timestamp=' + timestamp(),'randomIntegerChanged')">
