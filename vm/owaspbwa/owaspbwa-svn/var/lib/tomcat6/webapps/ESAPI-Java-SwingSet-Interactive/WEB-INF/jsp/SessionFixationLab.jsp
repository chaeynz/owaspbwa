...
<h3>Step 1</h3>
<p>Open this <a href="main?function=InsecureLogin&lab" target="_blank">link</a> in a new browser window and login using the following user details :</p>
<p>username : test <br/>password : test<br/><br/>Make a note of the session id displayed.</p>

<h3>Step 2</h3>
<p>Open a new browser window and browse to the following URL: .../LoginServletLab. <br> You should be told that you are not logged in.  
<h3>Step 3</h3>
<p>
