...
<%=JspGenerator.generateNavigation(Chapter.ENCODING, 5)%>
<div id="header"></div>
<p>
<hr>
...
(For more information on the user and log messages of ESAPI's Exception classes, c.f. the <a href="main?function=ErrorHandling">ErrorHandling Tutorial</a>)</p>
