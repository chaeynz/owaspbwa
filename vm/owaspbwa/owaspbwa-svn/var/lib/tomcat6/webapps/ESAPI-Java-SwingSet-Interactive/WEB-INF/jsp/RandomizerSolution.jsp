...
<form name="secureDemo" action="?function=Randomizer&solution" method="post">
	...
	<div>
		...
		<br /><br />
		<input type="button" value="Get Random Boolean" onclick="sendAjaxRequest('ajax?function=Randomizer&solution&method=getRandomBoolean&timestamp='+timestamp(),'booleanChanged')" />
	</div>
	<div>
		...
		<input type="button" value="Submit" onclick="sendAjaxRequest('ajax?function=Randomizer&solution&method=getRandomFileName&fileExtension=' + document.secureDemo.fileExtension.value + '&timestamp=' + timestamp(),'randomFileNameChanged')">
	...
	<div>
		...
		<input type="button" value="Submit" onclick="sendAjaxRequest('ajax?function=Randomizer&solution&method=getRandomInteger&min=' + document.secureDemo.min.value + '&max=' + document.secureDemo.max.value + '&timestamp=' + timestamp(),'randomIntegerChanged')">
