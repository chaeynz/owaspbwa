...
<a href="admin_lab.jsp" target="_blank">admin_lab.jsp</a><br /><br />
<p>Try changing the URLAccessRules.txt file and change the rule of admin_lab.jsp from<br /> | any      | allow  | to | any      | deny  |.</p>
