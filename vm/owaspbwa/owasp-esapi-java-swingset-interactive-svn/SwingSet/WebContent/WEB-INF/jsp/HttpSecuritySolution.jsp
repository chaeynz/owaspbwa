...
<a href="main?function=HttpSecurity&solution&redirect=http://www.google.com" target="_blank">main?function=HttpSecurity&solution&redirect=http://www.google.com</a>
</p>
...
<form action="main?function=HttpSecurity&solution" method="POST">
		<select name="redirect">
			...
			<option value="main?function=HttpSecurity&lab">Redirect to Lab</option>
		</select>
