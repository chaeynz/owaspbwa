...
<%=JspGenerator.generateNavigation(Chapter.ENCODING, 2)%>
<div id="header"></div>
<p>
...
<%
	...
	Codec mysqlansi = new MySQLCodec( MySQLCodec.Mode.ANSI);
	Codec mysql = new MySQLCodec( MySQLCodec.Mode.STANDARD);
%>

<h2>HTML Encoding Solution</h2>
<h4>JSP Location: WebContent\WEB-INF\jsp\EncodingSolution.jsp</h4>

<p>Enter whatever input you want. Click submit and the table below will be populated using different Encoding methods.</p>
