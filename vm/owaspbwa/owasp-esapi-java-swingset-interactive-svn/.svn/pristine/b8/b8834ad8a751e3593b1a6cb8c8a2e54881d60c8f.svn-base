		...
		try {
			...
			if ( function != null ) {
				...
				try {
					...
					// CP_2012-08-08 Added a separate catch case so that it does not print the stack trace
					// if an action class is missing
					logger.warning(Logger.SECURITY_FAILURE, "Action class not found " + prefix + pname + ".java");
				} catch( Exception e ) {
