...
<form name="secureDemo" action="?function=Randomizer&lab" method="POST">
	<div>
		...
		<br /><br />
		<input type="button" value="Get Random Boolean" onclick="sendAjaxRequest('/SwingSet/ajax?function=Randomizer&lab&method=getRandomBoolean&timestamp='+timestamp(),'booleanChanged')" />
	</div>
	<div>
