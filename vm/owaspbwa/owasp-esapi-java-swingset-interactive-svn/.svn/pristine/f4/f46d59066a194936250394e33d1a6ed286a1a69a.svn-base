...
<p>Log4j is set up to print to the console by default. In this application, it was also set up to print to the log file as defined in log4j.xml in the src folder.</p>
