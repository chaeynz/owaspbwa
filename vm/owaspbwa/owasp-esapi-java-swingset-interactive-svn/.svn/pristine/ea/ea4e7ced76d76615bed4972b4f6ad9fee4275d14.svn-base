...
<div id="navigation">
<a href="main">Home</a> | 
<b><a href="main?function=Encryption">Tutorial</a></b> | 
...
<ul>
 <li><b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/Encryptor.html#decrypt(org.owasp.esapi.crypto.CipherText)">PlainText decrypt(CipherText ciphertext)</a></b> 
         <br /> Decrypts the provided CipherText (encrypted with the encrypt method) and returns a PlainText.</li> 
 <li><b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/Encryptor.html#encrypt(org.owasp.esapi.crypto.PlainText)">CipherText encrypt(PlainText plaintext)</a></b> 
         <br /> Encrypts the provided PlainText and returns a CipherText.</li> 
</ul>
<p>Encryption & decryption using ESAPI's encryptor interface can be done as follows:</p>
<p class="newsItem">
<code>
String decrypted = "Unencrypted text";<br />
PlainText plainText = new PlainText(decrypted);<br />
CipherText cipherText = ESAPI.encryptor().encrypt(plainText);<br />
<br />
plainText = ESAPI.encryptor().decrypt(cipherText);<br />
...
<ul>
<li><b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/Encryptor.html#getRelativeTimeStamp(long)">getRelativeTimeStamp(long offset)</a></b> 
          Gets an absolute timestamp representing an offset from the current time to be used by other functions in the library.</li>
 <li><b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/Encryptor.html#getTimeStamp()"> long getTimeStamp()</a></b> Gets a timestamp representing the current date and time to be used by other functions in the library.</li> 
 <li><b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/Encryptor.html#hash(java.lang.String, java.lang.String)">String hash(java.lang.String plaintext, java.lang.String salt) </a></b>
           Returns a string representation of the hash of the provided plaintext and salt.</li> 
 <li><b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/Encryptor.html#seal(java.lang.String, long)">String seal(java.lang.String data, long timestamp) </a></b>
           Creates a seal that binds a set of data and includes an expiration timestamp.</li> 
 <li><b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/Encryptor.html#sign(java.lang.String)">String sign(java.lang.String data) </a></b>
           Create a digital signature for the provided data and return it in a string.</li> 
 <li><b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/Encryptor.html#unseal(java.lang.String)">String unseal(java.lang.String seal) </a></b>
 ...
 <li><b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/Encryptor.html#verifySignature(java.lang.String, java.lang.String)">boolean verifySignature(java.lang.String signature, java.lang.String data)</a></b> 
...
<ul>
	<li> <b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/reference/DefaultRandomizer.html#getRandomBoolean()">boolean getRandomBoolean()</a></b> 
	          Returns a random boolean. </li><br />	<br />
	          
	<li> <b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/reference/DefaultRandomizer.html#getRandomFilename(java.lang.String)">String getRandomFilename(String extension)</a></b> 
	          Returns an unguessable random filename with the specified extension.</li><br /><br />
	
	<li> <b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/reference/DefaultRandomizer.html#getRandomGUID()">String getRandomGUID()</a></b>
	          Generates a random GUID. </li><br /><br />
	
	<li> <b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/reference/DefaultRandomizer.html#getRandomInteger(int,%20int)">int getRandomInteger(int min, int max)</a></b> 
	          Gets the random integer. </li><br /><br />
	
	<li> <b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/reference/DefaultRandomizer.html#getRandomLong()">long getRandomLong()</a></b> 
	          Gets the random long. </li><br /><br />
	
	<li> <b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/reference/DefaultRandomizer.html#getRandomReal(float,%20float)">float getRandomReal(float min, float max)</a></b> 
	          Gets the random real. </li><br /><br />
	
	<li> <b><a href="http://owasp-esapi-java.googlecode.com/svn/trunk_doc/latest/org/owasp/esapi/reference/DefaultRandomizer.html#getRandomString(int,%20char[])">String getRandomString(int length, char[] characterSet)</a></b> 
          Gets a random string of a desired length and character set. </li>
</ul>

<h4>ESAPI Encryptor Configuration</h4>
<p>java -classpath esapi-2.0.1.jar;log4j-
1.2.16.jar org.owasp.esapi.reference.crypto.JavaEncryptor</p>
