...
public final class redirect_002durl_002dbasic_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("<head>\n");
      out.write("<title>OWASP ZAP WAVE - Redirect URL basic</title>\n");
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("<H2>OWASP ZAP WAVE - Simple redirection via a URL parameter</H2>\n");
      out.write("<H3>Description</H3>\n");
      out.write("The 'redir' parameter in the URL can be used to redirect the user to any web page, not just those in WAVE.\n");
	...
	if (request.getMethod().equals("GET") && redir != null) {
      ...
      out.write("\n");
      out.write("\n");
      out.write("Example link: <A HREF=\"redirect-url-basic.jsp?redir=redirect-index.jsp\">Simple redirect via a URL parameter</A>\n");
      out.write("\n");
      out.write("</body>\n");
      out.write("\n");
    } catch (Throwable t) {
