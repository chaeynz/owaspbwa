...
module RbConfig
  ...
  CONFIG["MINOR"] = "9"
  CONFIG["TEENY"] = "1"
  CONFIG["PATCHLEVEL"] = "286"
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/rvm/rubies/ruby-1.9.3-p286")
  ...
  CONFIG["configure_args"] = " '--enable-shared' '--disable-install-doc' '--prefix=/usr/local/rvm/rubies/ruby-1.9.3-p286' '--with-readline' '--with-opt-dir=/usr' 'CFLAGS=-I/usr/local/rvm/usr/include' 'LDFLAGS=-L/usr/local/rvm/usr/lib'"
  ...
  CONFIG["LDFLAGS"] = "-L. -L/usr/local/rvm/usr/lib -rdynamic -Wl,-export-dynamic"
  CONFIG["CFLAGS"] = "-I/usr/local/rvm/usr/include -fPIC"
  CONFIG["CC"] = "gcc"
  ...
  CONFIG["RUBY_RELEASE_DATE"] = "2012-10-12"
