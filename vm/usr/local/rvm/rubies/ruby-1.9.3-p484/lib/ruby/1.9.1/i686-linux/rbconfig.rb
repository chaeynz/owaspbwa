...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/rvm/rubies/ruby-1.9.3-p484")
  ...
  CONFIG["configure_args"] = " '--enable-shared' '--disable-install-doc' '--prefix=/usr/local/rvm/rubies/ruby-1.9.3-p484' 'CFLAGS=-I/usr/local/rvm/usr/include' 'LDFLAGS=-L/usr/local/rvm/usr/lib'"
