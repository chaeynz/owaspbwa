...
#define WITH_MODULES
#endif
#define LIBXSLT_DEFAULT_PLUGINS_PATH() "/usr/local/rvm/gems/ruby-1.9.3-p484@railsgoat/gems/nokogiri-1.6.1/ports/i486-linux-gnu/libxslt/1.1.26/lib/libxslt-plugins"
#endif
