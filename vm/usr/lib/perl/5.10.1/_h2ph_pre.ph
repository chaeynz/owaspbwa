...
unless (defined &__GLIBC_MINOR__) { sub __GLIBC_MINOR__() { 11 } }
...
unless (defined &__VERSION__) { sub __VERSION__() { "\"4\.4\.3\"" } }
...
unless (defined &__i486) { sub __i486() { 1 } }

unless (defined &__i486__) { sub __i486__() { 1 } }
